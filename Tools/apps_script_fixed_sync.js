...
function onOpen() {
  ...
  ui.createMenu('⚙️ IELTS Admin')
    .addItem('Đồng bộ Dữ liệu Học Viên (Tự sinh Sheet)', 'syncStudents')
...
// HÀM TỰ SINH SHEET VÀ TẠO HYPERLINK VÀO TÊN
function syncStudents() {
  ...
  // Duyệt tạo tab cá nhân và chèn link vào tên (Cột A)
...
function onEdit(e) {
  ...
  if (sheet.getName() === "Students") {
    ...
    // NẾU SỬA TÊN HOẶC ID => GỌI CƠ CHẾ TỰ SINH SHEET ĐỒNG BỘ
    if (col === 1 || col === 2) {
      syncStudents();
    }
